        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-16 mb-32">
          ...
          <div className="flex flex-col gap-8 md:text-right">
            <div className="flex md:justify-end gap-6">
              <a href="https://https://www.instagram.com/akashkamblearts?igsh=NXNhZXduaXFoZTdw&utm_source=qr" className="p-3 border border-neutral-100 rounded-full hover:bg-black hover:text-white transition-all">
                <Instagram size={20} />
              </a>
