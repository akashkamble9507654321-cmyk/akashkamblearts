...
export const PORTFOLIO_DATA: PortfolioItem[] = [
  ...
  { id: 'c5', title: 'Parel Cha Samrat 2025', category: 'conceptual', imageUrl: 'https://i.ibb.co/V0CspSyR/pcs.jpg', description: 'There are eight forms of Bhairava, representing different directions and powers. One of them, Gruha Bhairava, represents the north and is a symbol of divine energy and fearlessness, which helps devotees to face the truth with courage.
Apart from his protective role, the fierce Bhairava also symbolizes the terrifying aspect of the divine and the consequences of immoral acts.
Bhishan Bhairava is associated with the destroyer of evil spirits and negativity, Bhishan Bhairava vehicle (vahana) is the lion.' },
